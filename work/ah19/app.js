/* ══════════════════════════════════════════════════════════════
   AH-19 PORTFOLIO CONSOLE

   One record, five instruments. The dial selects a channel; the
   screen, the slide viewer, the gauge bank, the needle meter and
   the tape are all just different ways of reading that same
   channel. Nothing on this page moves unless you moved something.
   ══════════════════════════════════════════════════════════════ */
