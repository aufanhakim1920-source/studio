/* ABYSSAL — a mineral spring, thirty metres down
 * ---------------------------------------------------------------------------
 * ⭐ THE OBJECT: the surface of water seen from underneath — caustics.
 *
 * Same craft as gallery 67 and as SYMBOLON beside it (raw WebGL, SDF/divide for
 * light, 1-exp tone mapping, one accent on near-black, a lerped response), but a
 * genuinely different object and a different mechanic. 67's ring leans toward
 * you. SYMBOLON's sign resolves. This one STILLS: the water calms where you hold
 * the cursor, and churns everywhere else.
 *
 * Load-bearing: the brand's whole claim is that the water is old, slow and
 * undisturbed. The page lets you make it still with your hand.
 */
