...
(function () {
  ...
  /* ---------------------------------------------------------
     ...
     --------------------------------------------------------- */
  var INK = "#3B2A46", PAPER = "#FFFFFF", GROUND = "#C9BCE4";
  ...
  var FORMS = {
    "Keychain": function (hue) {
      return wrap(hue,
        ...
        '<circle cx="100" cy="187" r="6" fill="#9A5B2E" stroke="' + INK + '" stroke-width="2.6"/>' +
    ...
    "Phone Strap": function (hue) {
      return wrap(hue,
        ...
        '<circle cx="100" cy="105" r="6.5" fill="#9A5B2E" stroke="' + INK + '" stroke-width="2.6"/>' +
    ...
    "Sticker": function (hue) {
      return wrap(hue,
        '<rect x="16" y="26" width="168" height="188" rx="8" fill="#E1DAF0" stroke="' + INK + '" stroke-width="3.5"/>' +
    ...
    "Postcard": function (hue) {
      return wrap(hue,
        ...
        '<circle cx="150" cy="70" r="12" fill="#9A5B2E" stroke="' + INK + '" stroke-width="2.4"/>' +
        head(90, 112, 0.86) +
    ...
    "Art Print": function (hue) {
      return wrap(hue,
        ...
        '<circle cx="140" cy="58" r="16" fill="#9A5B2E" opacity=".85" stroke="' + INK + '" stroke-width="2.4"/>' +
  ...
  function renderCatalogue() {
    ...
    grid.innerHTML = list.map(function (p, i) {
      var s = DATA.series_meta[p.series] || { name_id: p.series, hue: "#9A5B2E" };
  ...
  function renderQuotes() {
    $("#quoteGrid").innerHTML = QUOTES.quotes.map(function (q, i) {
      var s = DATA.series_meta[q.series] || { hue: "#9A5B2E" };
