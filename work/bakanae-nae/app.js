...
(function () {
  ...
  /* ---------------------------------------------------------
     ...
     --------------------------------------------------------- */
  var INK = "#2E2140", PAPER = "#FFFFFF", GROUND = "#C3B3DC";
  ...
  var FORMS = {
    "Keychain": function (hue) {
      return wrap(hue,
        ...
        '<circle cx="100" cy="187" r="6" fill="#E5A87C" stroke="' + INK + '" stroke-width="2.6"/>' +
    ...
    "Phone Strap": function (hue) {
      return wrap(hue,
        ...
        '<circle cx="100" cy="105" r="6.5" fill="#E5A87C" stroke="' + INK + '" stroke-width="2.6"/>' +
    ...
    "Sticker": function (hue) {
      return wrap(hue,
        '<rect x="16" y="26" width="168" height="188" rx="8" fill="#D6CAE8" stroke="' + INK + '" stroke-width="3.5"/>' +
    ...
    "Postcard": function (hue) {
      return wrap(hue,
        ...
        '<circle cx="150" cy="70" r="12" fill="#E5A87C" stroke="' + INK + '" stroke-width="2.4"/>' +
        head(90, 112, 0.86) +
    ...
    "Art Print": function (hue) {
      return wrap(hue,
        ...
        '<circle cx="140" cy="58" r="16" fill="#E5A87C" opacity=".85" stroke="' + INK + '" stroke-width="2.4"/>' +
  ...
  function renderCatalogue() {
    ...
    grid.innerHTML = list.map(function (p, i) {
      var s = DATA.series_meta[p.series] || { name_id: p.series, hue: "#E5A87C" };
  ...
  function renderQuotes() {
    $("#quoteGrid").innerHTML = QUOTES.quotes.map(function (q, i) {
      var s = DATA.series_meta[q.series] || { hue: "#E5A87C" };
